...
public class BeanManager {
	...
	private static class BeanInfo{
		...
		public Object getInstance(){
			// singletonで既に作成済みなら
			if(scope.equals(Scope.SINGLETON) && singletonInstance!=null){
			...
			try {
				Constructor<?> constructor = getClazz().getConstructor((Class<?>)null);
		...
		public String toString() {
			return "BeanInfo [id=" + id + ", className=" + className + ", initMethod="
					+ initMethod + ", clazz=" + clazz + ", instance=" + singletonInstance
					+ "]";
		}
	}
}
