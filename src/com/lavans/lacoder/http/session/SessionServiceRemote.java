...
import com.lavans.lacoder.http.session.net.SessionServerConnection;
import com.lavans.lacoder.http.session.net.SessionServerConnectionManager;
...
public class SessionServiceRemote {
	/** ロガー。debug用 */
	private static Log logger = LogFactory.getLog(SessionServiceRemote.class.getName());
